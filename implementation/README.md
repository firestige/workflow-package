...
| Governing model | [`docs/workflow-composition-model-2.0.0-candidate.md`](../../docs/workflow-composition-model-2.0.0-candidate.md) |
| Workflow authority | [`workflow.md`](workflow.md) remains the semantic source; the machine-readable Definition under [`definition/`](definition/) is its `DESIGN_REFERENCE` translation under [`agentops.workflow-dsl@2.0.0`](../../docs/contracts/workflow/workflow-definition-dsl-2.0.0-candidate.md) |
